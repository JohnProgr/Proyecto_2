...
module tb_divider_core;
    ...
    initial begin
        $dumpfile("tb_divider_core.vcd");
        $dumpvars(0, tb_divider_core);
        ...
        apply_case(6'd10, 4'd2,  6'd5,  4'd0, 1'b0);
        apply_case(6'd15, 4'd4,  6'd3,  4'd3, 1'b0);
        ...
        $display("Simulacion de divider_core finalizada.");
        $finish;
    end
