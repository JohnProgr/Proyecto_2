...
(
    ...
    debounce_sync f0 (.clk(clk), .rst(rst), .key(filas[0]), .key_pressed(filas_fil[0]));
    debounce_sync f1 (.clk(clk), .rst(rst), .key(filas[1]), .key_pressed(filas_fil[1]));
    debounce_sync f2 (.clk(clk), .rst(rst), .key(filas[2]), .key_pressed(filas_fil[2]));
    debounce_sync f3 (.clk(clk), .rst(rst), .key(filas[3]), .key_pressed(filas_fil[3]));
